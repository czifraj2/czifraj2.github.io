...
dogeSayings = ['Hajjjrrááá', 'Janiii', 'Czifra', 'sikerülni fog', 'ASD', 'ASDASD', 'ASDASDASD', 'CÍÍPP', 'Nahhh', 'Heeee?',]
...
HTMLActuator.prototype.message = function (won) {
  ...
  var message = won ? "Nyertél!!!" : "Vesztettél! Próbáld újra!";
...
HTMLActuator.prototype.scoreTweetButton = function () {
  ...
  tweet.setAttribute("data-via", "czifraj2");
  tweet.setAttribute("data-url", "http://czifraj2.github.io");
  tweet.setAttribute("data-counturl", "http://czifraj2.github.io/czifraj/");
  tweet.textContent = "Tweet";

  var text = "Én ennyi: " + this.score + " pontot értem el a Czifra János játékban " +
             "gyere és döntsd meg! #czifrajanosgame";
